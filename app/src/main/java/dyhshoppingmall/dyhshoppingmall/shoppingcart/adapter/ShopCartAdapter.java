package dyhshoppingmall.dyhshoppingmall.shoppingcart.adapter;
...
public class ShopCartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private CustomShoppingButton numberAddSubView;
        ...
        ViewHolder(View itemView) {
            ...
            numberAddSubView = (CustomShoppingButton) itemView.findViewById(R.id.numberAddSubView);
        ...
        public void setData(final GoodsBean goodsBean) {
            ...
            Glide.with(mContext)
                    .load(Constants.HOME_URL_IMAGE + goodsBean.getFigure())
                    .into(ivGov);
            ...
            numberAddSubView.setOnValueChangeListener(new CustomShoppingButton.OnValueChangeListener() {
                @Override
...
//            numberAddSubView.setOnValueChangeListener(new NumberAddSubView.OnNumberChangeListener() {
//                @Override
